        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_pending_contact_changes_accounts_user_id",
                        column: x => x.user_id,
                        principalTable: "accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "07c2d51e-1122-4609-a0bb-c1c440df85f8", "Admin", "ADMIN" },
                    { "2", "0878ab5d-8bf0-4f11-8a56-cf663d030189", "User", "USER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_pending_contact_changes_user_id_type",
